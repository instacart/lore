...
Core Functionality
------------------
- **lore.models** are compatibility wrappers for your favorite library — `Keras <https://keras.io/>`__, `XGBoost <https://https://xgboost.readthedocs.io/>`__, `SciKit Learn <http://scikit-learn.org/stable/>`__. They come with reasonable defaults for rough draft training out of the box.
